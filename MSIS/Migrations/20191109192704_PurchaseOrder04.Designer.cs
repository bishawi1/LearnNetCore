...
namespace TMS.Migrations
{
    ...
    [Migration("20191109192704_PurchaseOrder04")]
    partial class PurchaseOrder04
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MSIS.ViewModels.PurchaseOrderItemsViewModel", b =>
                {
                    ...
                    b.Property<int>("PurchaseOrderDetailsViewModelId");
                    ...
                    b.HasIndex("PurchaseOrderDetailsViewModelId");
            ...
            modelBuilder.Entity("MSIS.Models.Project", b =>
                {
                    b.HasOne("MSIS.Models.Customer", "Customers")
                        .WithMany()
            ...
            modelBuilder.Entity("MSIS.ViewModels.PurchaseOrderItemsViewModel", b =>
                {
                    b.HasOne("MSIS.ViewModels.PurchaseOrderDetailsViewModel")
                        .WithMany("OrderDetails")
                        .HasForeignKey("PurchaseOrderDetailsViewModelId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
